...
function BirthDay() {
  return (
    ...
    <div className={`    lg:mt-[85px] sm:mt-[10vw] md:mt-[85px]  flex flex-col items-center justify-center rounded-lg`} >
        ...
        {/* recent birth day */}
        <div className={`  ${style.shadows} flex flex-col mt-4 w-[90%] md:w-[40vw] p-2 rounded-lg`}>
...
<Comment/>
        ...
        {/* upcoming birthday */}
        <div className={`  ${style.shadows} flex flex-col w-[90%] md:w-[40vw] p-2 my-4 rounded-lg`}>
<a className='text-2xl font-semibold'>Upcomeing birthdays
</a>
<div className={`   flex items-center justify-between mx-1 md:p-3 p-1 md:mx-4 my-3  w-[90%] md:w-[40vw] rounded-lg`}>
       <ContactSection/>
<a className='pr-[3vw]'>(age)</a>
      ...
      {/* month wise birthday */}
      <div className={`  ${style.shadows} flex flex-col items-center  w-[90%] md:w-[40vw]  my-4 rounded-lg`}>
