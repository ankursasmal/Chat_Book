...
function Grid1ForNav() {
  ...
  return (
    <div   className='bg-white relative z-30'   >
     <div className='pl-[2px] md:pl-3  md:mr-6  mr-[3px]   overflow-y-auto h-[75vh] w-[23%] flex flex-col bg-white fixed top-[74px] left-0' style={{backgroundColor:'white'}} >
...
" alt=""   />
     ...
     {seen?   <div className='flex items-center my-2' onClick={()=>{setseen(false)}}>
        <IoChevronDownSharp className='md:mx-4 md:block hidden mx-[0px]'/>
               <Title name={'See'}  />
 ...
 " alt=""   />
        ...
        < CiImageOn className='md:mx-4 md:block hidden mx-[0px]'/>
         ...
         <MdOutlineKeyboardArrowUp className='md:mx-4 md:block hidden mx-[0px]'/>
                <Title name={'See'}  />
