...
function Grid1() {
  ...
  return (
     ...
     <div className='pl-3 mr-6    overflow-y-auto h-[75vh] md:w-[23%] w-[230px] flex flex-col bg-white fixed top-[74px] left-0' style={{backgroundColor:'white'}} >
...
" alt=""   />
 ...
 " alt=""   />
        ...
        <div className='h-[30vw] bg-white'></div>
