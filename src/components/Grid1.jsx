...
function Grid1() {
  ...
  return (
     <div className='pl-3 mr-6 mt-3 overflow-y-auto h-[700px] flex flex-col'>
...
" alt=""   />
 ...
 " alt=""   />
        ...
        <div className='flex items-center flex-wrap bottom-0'>
          ...
          <a>Terms .</a>
          <a>Advertising .</a>
          <div className='flex items-center'> <a>Ad Choices  .</a><TbAlertTriangle className='ml-[3px]'/>
 </div>
         <div className='flex items-center'>  <a>Cookies</a> <MdOutlineCopyright/> <a>2024</a></div>
