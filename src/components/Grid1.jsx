...
function Grid1() {
  ...
  return (
     ...
     <div className='pl-3 mr-6    overflow-y-auto  h-[96vh]  md:w-[23%] w-[230px] flex flex-col bg-white fixed top-[74px] left-0' style={{backgroundColor:'white'}} >
     ...
     <Link to='/'>     <Title name={'Ankur Sasmal'}/></Link>
...
" alt=""   />
 ...
 " alt=""   />
        ...
        {/* <div className='h-[8vw]'> 
         <div className=' bottom-0  fixed  bg-white     md:w-[23%] w-[230px] '>
        <div className='flex flex-col    '  > 
        <div className='flex items-center '> 
          ...
          <div className='flex items-center'><TbAlertTriangle className='ml-[3px]'/>  <a>Cookies</a> <MdOutlineCopyright/> <a>2024</a></div>
