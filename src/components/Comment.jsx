...
function Comment(props) {
  ...
  let [arr,setarr]=useState([]);
    // for create posts in comment section 
  let postfun=()=>{
  ...
  .then((data) => {
    console.log(data);
    // arr under value post req through fill then display arr ung map wher i want to use
    setarr([...arr,data]);
       setinputdata('');
...
setinputdata(e.target.value);
 ...
 />
 {/* above line */}
   {/* use context for parent to child value pass ref={textAreaRef} ->allvedio file a jaba */}

<div className="flex items-center justify-between m-3"  >
    <div className='flex items-center'>
    <MdOutlineInsertComment  className='m-1'/>
    <CiFaceSmile />
    <IoCameraReverseOutline  className='m-1'/>
    <PiGifDuotone className='mr-1' />

    </div>
    <IoMdSend  className='mr-1' onClick={postfun}  />
